...
import UserImage from 'components/user/Profile/UserImage';
import UserInfoInput from 'components/user/Profile/UserInfoInput';
import WithDrawalButton from 'components/user/Profile/WithDrawalButton';
